...
plt.plot(np.log10(mean_error_u[:,0]),'r',label='POD - Uniform')
plt.plot(np.log10(mean_error_u[:,1]),'b-o',label='POD - Distribution')
plt.plot(np.log10(mean_error_u[:,2]),'y-*',label='Weighted POD - Uniform')
