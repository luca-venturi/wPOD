...
plt.plot(np.log10(mean_error_u[:,0]),'b-o',label='Weighted Greedy - Uniform')
plt.plot(np.log10(mean_error_u[:,2]),'y-*',label='Weighted Greedy - Distribution')
