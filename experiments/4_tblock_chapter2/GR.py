...
plt.plot(np.log10(mean_error_u[:,0]),'b',label='Greedy - Distribution')
plt.plot(np.log10(mean_error_u[:,1]),'r',label='Greedy - Uniform')
plt.plot(np.log10(mean_error_u[:,2]),'y',label='Greedy - Linspace')
plt.plot(np.log10(mean_error_u[:,3]),'b--',label='Greedy - Chebyshev')
plt.plot(np.log10(mean_error_u[:,4]),'r--',label='Greedy - Gauss Legendre')
plt.plot(np.log10(mean_error_u[:,5]),'y--',label='Greedy - Gauss Jacobi')
plt.legend()
plt.show()
