...
tb_0.set_weighted_flag(weight_function)
...
tb_1.set_weighted_flag(weight_function)
...
tb_2.set_weighted_flag(weight_function)
...
tb_3.set_weighted_flag(weight_function)

tb_3.setmu(first_mu)
tb_3.offline() 

tb_3.setxi_test(N_xi_test, sampling=originalDistribution)
...
tb_4.set_weighted_flag(weight_function)

tb_4.setmu(first_mu)
tb_4.offline() 

tb_4.setxi_test(N_xi_test, sampling=originalDistribution)
...
tb_5.set_weighted_flag(weight_function)

tb_5.setmu(first_mu)
tb_5.offline() 

tb_5.setxi_test(N_xi_test, sampling=originalDistribution)
mean_error_u[:,5] = tb_5.error_analysis()

# 7. Plot the errors

plt.plot(np.log10(mean_error_u[:,0]),'b',label='WGreedy - Distribution')
plt.plot(np.log10(mean_error_u[:,1]),'r',label='WGreedy - Uniform')
plt.plot(np.log10(mean_error_u[:,2]),'y',label='WGreedy - Linspace')
plt.plot(np.log10(mean_error_u[:,3]),'b--',label='WGreedy - Chebyshev')
plt.plot(np.log10(mean_error_u[:,4]),'r--',label='WGreedy - Gauss Legendre')
plt.plot(np.log10(mean_error_u[:,5]),'y--',label='WGreedy - Gauss Jacobi')
plt.legend()
plt.show()
