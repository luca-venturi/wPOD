...
tb_1.setxi_train(100, sampling=distribution)
...
plt.plot(np.log10(mean_error_u[:,0]),'r',label='Gauss-Jacobi(10,10) POD')
plt.plot(np.log10(mean_error_u[:,1]),'b-o',label='Sparse Gauss-Jacobi(10,10) POD')
