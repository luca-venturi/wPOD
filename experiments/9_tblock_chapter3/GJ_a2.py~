...
distribution = QuadratureDistribution('GaussJacobi',1,alpha=Qparam)
...
plt.plot(np.log10(mean_error_u[:,0]),'r',label='Gauss-Jacobi(75,75) POD')
plt.plot(np.log10(mean_error_u[:,1]),'b-o',label='Sparse Gauss-Jacobi(75,75) POD')
